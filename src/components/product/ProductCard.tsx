  ...
  return (
    <div className="group relative flex w-full flex-col">
      ...
      <Link
        ...
        className="flex flex-1 flex-col overflow-hidden rounded-xl border border-line bg-white transition duration-200 hover:-translate-y-1 hover:border-navy/20 hover:shadow-xl"
      >
        ...
        <div className="flex flex-1 flex-col p-5">
          ...
          {product.needs.length > 0 && (
            <div className="mt-auto flex flex-wrap gap-1.5 border-t border-line/60 pt-4">
